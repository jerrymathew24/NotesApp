...
const Text = () => {
  ...
  return (
    <div>
      <div className="flex flex-col w-[300px] relative border-1 border-gray-500 rounded-md p-5 mt-5">
        <input
          value={title}
        ...
        />
        <button disabled={!title.length > 0} onClick={onAddClick} className="bg-gray-500 text-white p-2 rounded-md absolute bottom-5 right-5">
          Add
        </button>
      </div>
    </div>
